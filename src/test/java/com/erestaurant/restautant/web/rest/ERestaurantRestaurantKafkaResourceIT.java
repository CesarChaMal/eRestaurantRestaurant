...
import com.erestaurant.restautant.config.EmbeddedKafka;
...
@WithMockUser
@EmbeddedKafka
class ERestaurantRestaurantKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/e-restaurant-restaurant-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/e-restaurant-restaurant-kafka/consume")
